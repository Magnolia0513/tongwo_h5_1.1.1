...
function getSign(e, t, n) {
  ...
  return o = r(c + (n = n || getApp().globalData.siteInfo.token));
}

util.url = function (e, t) {
  var n = getApp(),
      a = n.globalData.siteInfo.siteroot + "?i=" + n.globalData.siteInfo.uniacid + "&t=" + n.globalData.siteInfo.multiid + "&v=" + n.globalData.siteInfo.version + "&from=wxapp&";
  ...
  var n = uni.getStorageSync("userInfo").sessionid,
      i = a.url;
  ...
  if (-1 == i.indexOf("http://") && -1 == i.indexOf("https://") && (i = util.url(i)), getUrlParam(i, "state") || a.data && a.data.state || !n || (i = i + "&state=we7sid-" + n), !a.data || !a.data.m) {
    ...
    o.length && (o = o[getCurrentPages().length - 1]) && o.__route__ && (i = i + "&m=zh_cjdianc");
  }
  ...
  if (uni.showNavigationBarLoading(), a.showLoading && util.showLoading(), a.cachetime) {
    var u = t(i),
        c = uni.getStorageSync(u),
        g = Date.parse(new Date());

    if (c && c.data) {
      if (c.expire > g) return a.complete && "function" == typeof a.complete && a.complete(c), a.success && "function" == typeof a.success && a.success(c), console.log("cache:" + i), uni.hideLoading(), uni.hideNavigationBarLoading(), !0;
      uni.removeStorageSync(u);
    }
  }

  uni.request((_defineProperty(e = {
    url: i,
    data: a.data ? a.data : {},
    ...
    if (uni.hideNavigationBarLoading(), uni.hideLoading(), e.data.errno) {
      ...
      if (a.fail && "function" == typeof a.fail) a.fail(e);else if (e.data.message) {
        ...
        r.globalData.util.message(e.data.message, t, "error");
      }
    ...
    uni.login({
      success: function (e) {
        util.request({
          ...
          cachetime: 0,
          success: function (e) {
            e.data.errno || (t.sessionid = e.data.data.sessionid, uni.setStorageSync("userInfo", t), uni.getUserInfo({
              success: function (e) {
                t.wxInfo = e.userInfo, uni.setStorageSync("userInfo", t), util.request({
                  ...
                  cachetime: 0,
                  success: function (e) {
                    e.data.errno || (t.memberInfo = e.data.data, uni.setStorageSync("userInfo", t)), "function" == typeof n && n(t);
                  }
                });
              },
              fail: function () {},
      ...
      t = uni.getStorageSync("userInfo");

  t.sessionid ? uni.checkSession({
    success: function () {
      "function" == typeof n && n(t);
    },
    fail: function () {
      t.sessionid = "", console.log("relogin"), uni.removeStorageSync("userInfo"), e();
    }
  }) : e();
  ...
  n || (n = "success"), "success" == n ? uni.showToast({
    title: e,
    icon: "success",
    duration: 2e3,
    mask: !!r,
  ...
  uni.getStorageSync("isShowLoading") && (uni.hideLoading(), uni.setStorageSync("isShowLoading", !1)), uni.showLoading({
    title: "加载中",
    complete: function () {
